...
const SearchUser = () => {
  ...
  const { mutate: editFollow } = useMutation({
    ...
    onMutate: async ({ userUid, targetUid, type }) => {
      ...
      queryClient.setQueryData(['users', searchKeyword], (prevUsers) => {
        console.log(`prevUsers setQuery시작`, prevUsers);
        ...
        console.log(`prevPages setQuery끝`, newPages);
        ...
        <ContentWrap>
          ...
          <div>
            {usersToShow?.map((user, index) => {
              ...
              console.log(user?.nickName, isMyProfile);
              return (
                    ...
                    {!isMyProfile && (
                      <>
                        {user?.follower.includes(userUid) ? (
                          <div onClick={() => editFollow({ userUid, targetUid: user?.uid, type: 'removeFollowing' })}>
                            언팔로우
                          </div>
                        ) : (
                          <div onClick={() => editFollow({ userUid, targetUid: user?.uid, type: 'addFollowing' })}>
                            팔로우
                          </div>
                        )}
                      </>
